...
public class CollisionChecker {
    ...
    public void checkTile(Entity entity ) {
        ...
        // pe baza lor vom afla row, col;
        // coodronatele varfurilor rectangluarului din interiorul playerului

        int entityLeftCol = entityLeftWorldX / gp.tileSize;
        int entityRightCol = entityRightWorldX / gp.tileSize;
        int entityTopRow = entityTopWorldY / gp.tileSize;
        int entityBottomRow = entityBottomWorldY / gp.tileSize;
        // pe ce row, col se afla entity
        ...
        switch (entity.direction) {
            case "up":
                ...
                if (gp.tiledMapViewer.tileCollision[tileNum1] || gp.tiledMapViewer.tileCollision[tileNum2]) {
